...
const InsertionSort: React.FC = () => {
  const [originalArray, setOriginalArray] = useState<number[]>([12, 11, 13, 5, 6]);
  ...
  const [inputArray, setInputArray] = useState<string>('12,11,13,5,6');
  const [speed] = useState<number>(1000);
  const [activeLanguage, setActiveLanguage] = useState<string>('javascript');
  const intervalRef = useRef<number | null>(null);

  // Generate insertion sort steps for the current array
  const generateInsertionSortSteps = (arr: number[]): InsertionSortStep[] => {
    ...
    for (let i = 1; i < workingArray.length; i++) {
      ...
      steps.push({
        ...
        message: `Picked key ${key} at index ${i}`,
      });
      while (j >= 0 && workingArray[j] > key) {
        ...
        steps.push({
          ...
          array: [...workingArray],
          sorted: Array.from({ length: i }, (_, idx) => idx),
          message: `Shifted ${workingArray[j]} to the right`,
        });
        j = j - 1;
      }
  ...
  useEffect(() => {
    if (originalArray.length > 0) {
      const steps = generateInsertionSortSteps(originalArray);
      setSortSteps(steps);
      setCurrentStep(-1);
      setIsPlaying(false);
      setIsPaused(false);
  ...
  const resetArray = () => {
    setOriginalArray([12, 11, 13, 5, 6]);
    setInputArray('12,11,13,5,6');
  };
  ...
  const getElementClass = (index: number) => {
    ...
    if (step.key !== null && array[index] === step.key) return 'bg-pink-300 border-pink-600 text-pink-900 font-bold scale-105 shadow';
  ...
  const getCurrentMessage = () => {
    ...
    return 'Click "Start" to begin the insertion sort visualization';
  };
  ...
  return (
    <div className="min-h-screen bg-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-extrabold text-zinc-900">Insertion Sort</h1>
          <p className="text-zinc-700 text-lg mt-2">
            A simple, intuitive sorting algorithm that builds the sorted array one element at a time by inserting elements into their correct position.
          </p>
        ...
        {/* Info Section */}
        <div className="mb-8">
          <h4 className="flex items-center gap-2 text-zinc-900 text-xl font-semibold mb-3"><i className="bi bi-info-circle text-indigo-600"></i> How Insertion Sort Works</h4>
          <p className="text-zinc-700 leading-relaxed">
            Insertion Sort iterates through the array, growing a sorted section at the start. For each element, it finds the correct position in the sorted section and inserts it there, shifting larger elements to the right.
          </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h6 className="font-semibold text-zinc-900 mb-2">Insertion Phase:</h6>
              <ol className="list-decimal list-inside text-zinc-700 space-y-1">
                <li>Pick the next element from the unsorted section</li>
                <li>Compare it with elements in the sorted section</li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside text-zinc-700 space-y-1">
                ...
                <li>Continue until the whole array is sorted</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded px-4 py-2 text-indigo-700">
            ...
            <strong>Tip:</strong> Use the controls to step through the insertion sort algorithm. Watch how the key is compared and inserted.
          </div>
        </div>
            ...
            <table className="min-w-full border border-gray-300 rounded-lg">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-2 border border-gray-300">Already sorted array</td>
                </tr>
                <tr>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <h6 className="flex items-center gap-2 font-semibold text-zinc-900 mb-2">
                <i className="bi bi-database text-green-600"></i> Nearly Sorted Data
              </h6>
              <p className="text-zinc-700 text-sm">Performs well on nearly sorted arrays</p>
            </div>
            <div className="bg-white rounded-lg shadow p-4">
              <h6 className="flex items-center gap-2 font-semibold text-zinc-900 mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <ul className="list-disc list-inside text-zinc-700 space-y-1">
              ...
              <li>Adaptive (fast for nearly sorted data)</li>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <ul className="list-disc list-inside text-zinc-700 space-y-1">
              ...
              <li>O(n²) time complexity in worst case</li>
              <li>Not suitable for massive data</li>
            </ul>
          </div>
        </div>
      </div>
